...
def preprocessing_tool(state):
    ...
    with open("D:/VentureInternship/AI Agent/IELTSBot/preprocessed_data.json", 'w') as file:
        json.dump(preprocessed_data, file, indent=4)

    with open("D:/VentureInternship/AI Agent/IELTSBot/response.txt", "w") as file:
        file.write(f"\nPreprocessing_Tool")
