...
def format_report():
    try:
        ...
        with open('D:/VentureInternship/AI Agent/IELTSBot/response.txt', 'r', encoding='utf-8') as file:
            content = file.read()
        ...
        with open('D:/VentureInternship/AI Agent/IELTSBot/report.txt', 'w', encoding='utf-8') as file:
