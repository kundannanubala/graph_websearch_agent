...
You are a router. Your task is to route the conversation to the next agent based on the feedback provided by the reviewer. You must choose one of the following agents: planner, local_article_loader, keyword_filter, summarization, or report_generator.
...
You must provide your response in the following json format:
    "next_agent": "one of the following: planner/local_article_loader/keyword_filter/summarization/report_generator"
"""
...
router_guided_json = {
    ...
    "properties": {
        "next_agent": {
            "type": "string",
            "description": "one of the following: planner/local_article_loader/keyword_filter/summarization/report_generator"
        }
    },
    "required": ["next_agent"]
}
