...
def knowledge_base_loader(state):
    try:
        ...
        with open('D:/VentureInternship/AI Agent/IELTSBot/knowledge_base.txt', 'r', encoding='utf-8') as file:
        ...
        # Log the action
        with open("D:/VentureInternship/AI Agent/IELTSBot/response.txt", "a") as log_file:
